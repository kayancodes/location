...
class FiltreExtension extends AbstractExtension{
    ...
    {
        // <td class="text-end">{{vehicule.prixJournalier | deviseFr}}</td>
        return [
    ...
    public function civilite (string $civilite ): string{
        ...
        if($civilite === "F") return "<svg xmlns=\"http://www.w3.org/2000/svg\" width=\"16\" height=\"16\" fill=\"currentColor\" class=\"bi bi-gender-female\" viewBox=\"0 0 16 16\">
